...
import * as ColorUtils from '@/utils/colour-utils';
			...
			<PopoverContent className='w-80'>
				<div className='grid gap-4'>
					<div
						...
						<div
							className='absolute w-4 h-4 border-2 border-accent-foreground rounded-full -translate-x-1/2 -translate-y-1/2 pointer-events-none shadow-md'
							style={{
								left: `${hsl.s}%`,
								top: `${100 - hsl.l}%`,
					...
					<div className='grid gap-2'>
						...
						<div className='relative'>
							<Slider
								...
								max={360}
								step={1}
								className='[&_[role=slider]]:h-4 [&_[role=slider]]:w-4 [&_.bg-primary]:bg-transparent [&_.bg-secondary]:bg-transparent border-border rounded-lg'
